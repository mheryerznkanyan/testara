  ...
  return (
    <div className="glass-card w-full max-w-sm p-8 space-y-6">
      ...
      <div className="text-center">
        ...
        <h1 className="text-xl font-bold font-headline">Welcome back</h1>
        <p className="text-sm text-zinc-500 mt-1">Sign in to your Testara account</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Enter your password" required
            className="w-full bg-surface-low border border-outline-variant/20 rounded-xl px-4 py-2.5 text-sm text-white placeholder:text-zinc-600 focus:outline-none focus:border-primary transition-all"
          />
        </div>
